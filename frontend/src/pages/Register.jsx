...
export default function Register() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        const { Username, email, phone, password, role, ngoNumber, rememberMe, termsAgreed } = formData;
        ...
        <>
                ...
                <form className="bg-white p-8 rounded-lg shadow-md w-full max-w-md" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 py-4">
                        ...
                        <div className="flex space-x-4 justify-between">
                           ...
                           <button onClick={handleLocation} className="bg-gray-700 cursor-pointer text-white p-3 rounded-md"> Get Location</button>
            ...
            >
                ...
                <div className="flex justify-between mt-4">
                    <button className="bg-red-500 text-white px-4 py-2 rounded cursor-pointer" onClick={() => setShowOtpModal(false)}>
                        Cancel
                    </button>
                    <button className="bg-green-500 text-white px-4 py-2 rounded cursor-pointer" onClick={handleVerifyOtp}>
                        Verify OTP
                    </button>
                </div>
